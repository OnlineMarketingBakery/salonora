...
- **`founder_story_split`** — About-style gradient card: `avatar`, `title`, `subtitle`, WYSIWYG `content`, `conclusion`, `main_image` (Figma **1083:46** “Group 594”; bg texture **`597:2281`** → `public/founder-story-card-bg.png` + **`597:2282`** brand `mix-blend-color`; **`597:2283`** → `public/founder-story-spark.png`; photo stack **`597:2287`**/**`597:2288`**; copy **`597:2954`** — lg grid `528 + 118 + 460` inside **1298×756** card, `rounded-[20px]`).
