...
- **`founder_story_split`** — About-style gradient card: `avatar`, `title`, `subtitle`, WYSIWYG `content`, `conclusion`, `main_image` (Figma **1083:46** “Group 594” = full section; inner layers include `597:2954` copy, `597:2279` bg, `597:2287`/`597:2288` photo stack; sparkle graphic **`597:2283`** → `public/founder-story-spark.png`, `rotate-180`, lg+ only — `597:2279` alone is only the bg layer).
