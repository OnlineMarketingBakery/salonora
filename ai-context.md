...
- **`combined_strengths`** — Figma **1090:47** (“Group 595”): blue gradient panel with `title` + `left_rows` (image + description); stacked white `content_cards` (title + description); full-width footer strip (`footer_logo`, `footer_text`).
