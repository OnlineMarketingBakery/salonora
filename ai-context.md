...
- **`combined_strengths`** — Figma **1090:47** (“Group 595”): solid brand panel + `left_rows`; white cards use **TR/BL radial gradient “border”** (2px, brand/rose via CMS `accent`) + Figma shadow `0 6px 20px rgba(129,154,205,.26)` — not a full stroke; flat `navy-deep` footer. Section `palette-surface`.
