...
const whiteCtaClassName =
  "group inline-flex h-12 w-full min-w-0 max-w-full items-center justify-center gap-[17px] rounded-[24px] bg-white px-3.5 text-base font-normal font-sans leading-normal text-navy shadow-[0px_6px_20px_0px_rgba(57,144,240,0.54)] transition hover:brightness-[0.99]";
