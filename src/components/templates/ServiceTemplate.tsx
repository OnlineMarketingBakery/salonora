  ...
  return (
    <article>
      <Container className="pt-10">
        ...
        {doc.excerpt && <div className="mt-2 text-slate-600" dangerouslySetInnerHTML={{ __html: doc.excerpt }} />}
        {doc.serviceIntro && <p className="mt-6 text-lg text-slate-700">{doc.serviceIntro}</p>}
