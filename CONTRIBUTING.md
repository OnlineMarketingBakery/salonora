...
- If you add an **ACF flexible layout** / section type, update **`src/lib/acf/section-registry.ts`**, normalizers, **`src/types/sections.ts`**, and document the layout name in **`ai-context.md`** if it is non-obvious.
